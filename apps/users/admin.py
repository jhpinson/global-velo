...
class User(admin.ModelAdmin):
    ...
    def get_fieldsets(self, request, obj=None):
        ...
        return super(User, self).get_fieldsets(request, obj)
    ...
    def get_urls(self):
        ...
        ) + super(User, self).get_urls()

    def lookup_allowed(self, lookup, value):
        # See #20078: we don't want to allow any lookups involving passwords.
        if lookup.startswith('password'):
            return False
        return super(User, self).lookup_allowed(lookup, value)
    ...
    def add_view(self, request, form_url='', extra_context=None):
        ...
        return super(User, self).add_view(request, form_url,
                                               extra_context)
    ...
    def response_add(self, request, obj, post_url_continue=None):
        ...
        return super(User, self).response_add(request, obj,
                                                   post_url_continue)
